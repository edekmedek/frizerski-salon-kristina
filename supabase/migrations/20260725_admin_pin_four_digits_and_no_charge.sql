-- Four-digit administrator calendar PIN and explicit no-charge appointment flag.
-- Additive migration. Existing users, appointments and client PINs are preserved.
...
revoke all on function public.admin_set_calendar_pin(text, text) from public, anon;
revoke all on function public.admin_verify_calendar_pin(text) from public, anon;
